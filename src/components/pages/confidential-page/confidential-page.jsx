                ...
                <div className="row mb-3">
                    <div className="col" style={{ border: 'solid 2px #eee', padding: '20px' }}>
                        <div id="inputResult">
                            ...
                            <div className="row mb-4">
                                <div className="col">
                                    ...
                                    <div className="descr">
                                        ...
                                        данных, предпринимаемые <span className="link mark owner-name-field" id="owner-name-value" data-scroll-to="#owner-name-field">Свиридчик Викторией
                                            </span> (далее&nbsp;— Оператор).
                                    </div>
                                    <div className="ol">
                                        <div className="li">
                                        ...
                                        <div className="li">
                                            ...
                                            которую Оператор может получить о&nbsp;посетителях веб-сайта <span className="link mark owner-site-url-field" data-scroll-to="#owner-site-url-field"></span>.
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div className="col">
                                    ...
                                    <div className="ol">
                                        ...
                                        <div className="li">
                                            ...
                                            их&nbsp;доступность в&nbsp;сети интернет по&nbsp;сетевому адресу <span className="link mark owner-site-url-field" data-scroll-to="#owner-site-url-field"></span>.
                                        </div>
                                        <div className="li">
                                        ...
                                        <div className="li">2.8. Персональные данные&nbsp;— любая информация,
                                            ...
                                            Пользователю веб-сайта <span className="link mark owner-site-url-field" data-scroll-to="#owner-site-url-field"></span>.
                                        </div>
                                        <div className="li">
                                        ...
                                        <div className="li">
                                            2.10. Пользователь&nbsp;— любой посетитель веб-сайта <span className="link mark owner-site-url-field" data-scroll-to="#owner-site-url-field"></span>.
                                        </div>
                                        <div className="li">
                            ...
                            <div className="row mb-4">
                                <div className="col">
                                    <h3>6. Условия обработки персональных данных</h3>
                                    <div className="ol">
                                        <div className="li">
                                        ...
                                        <div className="li">
                                            6.3. Обработка персональных данных необходима для осуществления правосудия,
                                        ...
                                        <div className="li">
                                            6.5. Обработка персональных данных необходима для осуществления прав
                                        ...
                                        <div className="li">
                                            6.6. Осуществляется обработка персональных данных, доступ неограниченного
                                        ...
                                        <div className="li">
                                            6.7. Осуществляется обработка персональных данных, подлежащих опубликованию
                            ...
                            <div className="row mb-4">
                                <div className="col">
                                    <h3>
                                        7. Порядок сбора, хранения, передачи и&nbsp;других видов обработки персональных
                                        данных
                                    </h3>
                                    <div className="descr">
                                    ...
                                    <div className="ol">
                                        ...
                                        <div className="li">
                                            ...
                                            Оператору уведомление на&nbsp;адрес электронной почты Оператора <span className="link mark owner-email-field" data-scroll-to="#owner-email-field">viccisviri@gmail.com</span>
                                            с&nbsp;пометкой «Актуализация персональных данных».
                                        </div>
                                        <div className="li">
                                            7.4. Срок обработки персональных данных определяется достижением целей, для
                                            ...
                                            посредством электронной почты на&nbsp;электронный адрес Оператора <span className="link mark owner-email-field" data-scroll-to="#owner-email-field">viccisviri@gmail.com</span>
                                        ...
                                        <div className="li">
                                            7.8. Оператор осуществляет хранение персональных данных в&nbsp;форме,
                                        ...
                                        <div className="li">
                                            7.9. Условием прекращения обработки персональных данных может являться
                            ...
                            <div className="row mb-4">
                                <div className="col">
                                    <h3>
                                        8. Перечень действий, производимых Оператором с&nbsp;полученными персональными
                                        данными
                                    </h3>
                                    <div className="ol">
                                        <div className="li">
                            ...
                            <div className="row mb-4">
                                <div className="col">
                                    ...
                                    <div className="ol">
                                        <div className="li">
                                            9.1. Оператор до&nbsp;начала осуществления деятельности
                                        ...
                                        <div className="li">
                                            9.2. Оператор до&nbsp;подачи вышеуказанного уведомления, обязан получить
                                ...
                                <div className="col">
                                    ...
                                    <div className="ol">
                                        <div className="li">
                                            ...
                                            к&nbsp;Оператору с&nbsp;помощью электронной почты <span className="link mark owner-email-field" data-scroll-to="#owner-email-field">viccisviri@gmail.com</span>.
                                        </div>
                                        <div className="li">
